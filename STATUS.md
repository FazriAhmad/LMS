...
Akademik, Kurikulum, Jadwal, Kalender, Courses/CourseDetail, Ujian/QuizPlayer/ExamPlayer, BankSoal, Nilai, Presensi, Progress, Komunikasi, OrangTua, Laporan, Files, Pengaturan. **Halaman-halaman ini akan tampil dengan data dummy seperti biasa** — itu memang scope yang disepakati, bukan bug.
